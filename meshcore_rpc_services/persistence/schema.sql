...
CREATE TABLE IF NOT EXISTS requests (
    ...
    completed_at  REAL,
    final_state   TEXT,        -- 'completed_ok' | 'completed_error'
    error_code    TEXT,        -- set when final_state='completed_error'
...
CREATE TABLE IF NOT EXISTS request_events (
    ...
    request_id  TEXT NOT NULL,   -- matches requests.id; not FK-enforced
    node_id     TEXT NOT NULL,   -- denormalized for easy joins / retention
    state       TEXT NOT NULL,
    detail      TEXT,
    ts          REAL NOT NULL
);
